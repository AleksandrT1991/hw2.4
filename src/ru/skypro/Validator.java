...
public class Validator {
    private static final String VALID_SYMBOLS = "abcdefghijklmnopqrstuvwxyzABCDEFGIJKLMNOPQRSTUVWXWZ123456789_";
    ...
    private static void validate(String login,
        ...
        if (Objects.isNull(login) || login.length() > 20) {
            throw new WrongLoginException("Длина логина не лолжна быть <=20");
        }
        ...
        if (isNotValidPassword(password) || isNotValidPassword(confirmPassword)) {
            throw new WrongPasswordException("Длина пароля должна  <20");
        }
